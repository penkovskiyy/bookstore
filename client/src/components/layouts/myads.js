...
class MyAds extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .get('http://localhost:5000/user/ads/' + path)
      .then((res) => {
  ...
  deleteAd(id) {
    axios
      .delete('http://localhost:5000/item/delete/' + id)
      .then((res) => {
        //console.log(res.data);
    ...
    return (
      <div id="myadd">
        ...
        {this.state.data.length === 0 ? (
          ...
          <ListItem data={this.state.data} deleteAd={this.deleteAd} />
        )}
      </div>
    )
  }
      ...
      {props.data.map((item) => {
        return (
          <div id="mylist" key={item._id}>
            <div id="myitem-img">
              <img
                src={'http://localhost:5000/uploads/' + item.photo[0]}
                alt="List-Item"
                height="120"
                id="img"
              />
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    ...
                    <button
                      ...
                      onClick={() => props.deleteAd(item._id)}
                    >
                      Yes
                    </button>
                  </div>
  ...
  return (
    <div style={{ marginTop: '20px' }}>
      <p style={{ textAlign: 'center' }}>
        <i className="far fa-frown" style={{ fontSize: '40px' }}></i>
      </p>
